...
type creditsSummary struct {
	...
	// creditsFetched records the last successful upstream resource fetch.
	// Unlike FetchedAt, cache stale-while-error handling must not advance it.
	creditsFetched time.Time
}
...
type packageSummary struct {
	...
	DeductionStartTime int64  `json:"deduction_start_time"`
	DeductionEndTime   int64  `json:"deduction_end_time"`
}
...
type resourcePackage struct {
	...
	DeductionStartTime  int64  `json:"DeductionStartTime"`
...
func managementRegistration() managementRegistrationResponse {
	...
	return managementRegistrationResponse{
		...
		Resources: []resourceRoute{
			{Path: "/panel", Menu: "WorkBuddy Global", Description: "WorkBuddy Global dashboard: credits, trial, plan, import."},
		},
	}
}
...
// mutating endpoints under /v0/management/plugins/workbuddy-global/* require a matching
