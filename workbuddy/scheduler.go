...
//
// Routing uses either the panel-selected active account (credits mode) or
// package deduction deadlines (expiry mode).
...
// panel-selected active account or package expiration deadlines.
